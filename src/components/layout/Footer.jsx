                        ...
                        <div className="flex gap-2 pt-1">
                            {[
                                ...
                                <a
                                    ...
                                    className="w-8 h-8 rounded-full bg-gray-100/80 border border-gray-200/60 text-gray-500 hover:text-primary hover:bg-primary/10 hover:border-primary/30 flex items-center justify-center transition-all duration-200 shadow-2xs"
                                >
